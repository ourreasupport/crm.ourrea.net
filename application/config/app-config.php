...
*
*/
define('APP_BASE_URL', 'https://crm.ourrea.net/');
...
*/
define('APP_ENC_KEY', '6296117beec48b7bd721d2b21587cd5f');
 ...
 */
define('APP_DB_USERNAME', 'crm.ourrea.com');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Ourrea7375@');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'crm.ourrea.com');
